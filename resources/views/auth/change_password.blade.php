...
@section('content')
    ...
    @if(session('success'))
        <!-- Mostrar mensaje contraseña exitosa -->
        <div class="row">
    ...
    @else
        ...
        <!-- Cambio al formuario de modificaión contraseña  -->
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 form-group">
                        {!! Form::label('new_password_confirmation', 'Confirmar nueva contraseña*', ['class' => 'control-label']) !!}
        ...
        {!! Form::submit(trans('Guardar Cambios'), ['class' => 'btn btn-danger']) !!}
        {!! Form::close() !!}
    @endif
@stop
